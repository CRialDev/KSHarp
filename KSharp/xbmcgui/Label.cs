namespace CRial.xbmcgui
{
    public class Label : Control
    {
        ...
        private Colors _shadowColor = Colors.Transparent;
        private Colors _focusedColor = Colors.Black;
        ...
        public Label(int x, int y, int width, int height, string label, Colors textColor, Colors disabledColor, string font = "font13", Alignment alignment = Alignment.CENTER_X, bool hasPath = false, int angle = 0) : base()
        {
            ...
            //
            Utils.Call(_name + " = xbmcgui.ControlLabel(" + x + "," + y + "," + width + "," + height + ",'" + label + "',font='" + _font + "', textColor='" + _textColor + "', disabledColor='" + _disabledColor + "', alignment=" + (int)alignment + ", hasPath=" + _hasPath.ToString() + ", angle=" + _angle + ")");
        }
